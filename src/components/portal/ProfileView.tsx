...
import { Settings, Shield, Award, Clock, Calendar, CreditCard, LogOut } from 'lucide-react';
          ...
          <div className="space-y-4">
            ...
            <div className="mt-4 pt-4 border-t border-light-border/10 dark:border-viridian/20">
              <button 
                ...
                className="w-full py-2 bg-red-500/10 hover:bg-red-500/20 text-red-500 font-medium rounded-lg border border-red-500/30 transition-colors flex items-center justify-center gap-2"
              >
                {isSigningOut ? (
                  <>
